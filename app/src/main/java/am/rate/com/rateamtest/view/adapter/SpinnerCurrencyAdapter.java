...
public class SpinnerCurrencyAdapter extends BaseAdapter {
    ...
    public SpinnerCurrencyAdapter(Context context, List<String> data) {
        this.mData = data;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.currency_spinner_view_item, null);
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        convertView = inflter.inflate(R.layout.currency_spinner_view_item, null);
